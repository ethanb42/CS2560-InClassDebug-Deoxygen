 ...
 * @date 12 April 2019
 * @brief File containing program for a theater seating chart
 *
*/
...
int row; /*!<Holds value for row*/
int column; /*!<Holds value for col*/
int columnTwo; /*!<Holds a 2nd col val*/
int loop = 1; /*!<Variable for main loop*/
int wasValid = 0; /*!<Used to return valid seat*/
...
//! The main program that calls other methods
/*!
 *
 *
 * \return Terminated program
 */
int mainMenu() {
	//initialize theater
	initializeTheater();
...
//! Creates a 2D array to represent the theater
/*!
 *
 *
 * \return default 0
 ...
 *
 *
 * \param r Row of the seat
 * \param c Col of the seat
 * \return 1 if valid seat, 0 if not
 */
int validSeat(int r, int c) {
...
//! The main program to execute the program
/*!
 *
 *
